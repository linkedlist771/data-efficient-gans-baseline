...
@click.option(
    "--cfg",
    help="Base config [default: low_shot]",
    type=click.Choice(
        ["low_shot", "auto", "stylegan2", "paper256", "paper512", "paper1024", "cifar"]
    ),
)
...
@click.option(
    "--DiffAugment",
    help="Comma-separated list of DiffAugment policy [default: color,translation,cutout]",
    type=str,
)
@click.option(
    "--aug",
